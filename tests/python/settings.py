...
SETTINGS_POSITIONS = {
    DeviceType.STAX: {
        SettingID.BLIND_SIGNING: (0, 350, 130),
        SettingID.DEBUG_DATA: (0, 350, 335)
    },
    DeviceType.FLEX: {
        SettingID.BLIND_SIGNING: (0, 420, 130),
        SettingID.DEBUG_DATA: (0, 420, 350)
    },
    DeviceType.APEX_P: {
        SettingID.BLIND_SIGNING: (0, 260, 90),
        SettingID.DEBUG_DATA: (0, 260, 235)
    },
    DeviceType.APEX_M: {
        SettingID.BLIND_SIGNING: (0, 260, 90),
        SettingID.DEBUG_DATA: (0, 260, 235)
...
def get_settings_moves(device: Device,
    ...
    if device.is_nano:
        moves += [NavInsID.RIGHT_CLICK, NavInsID.RIGHT_CLICK, NavInsID.BOTH_CLICK]
