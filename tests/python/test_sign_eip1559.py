...
def sign_transaction_1559(test_name, backend, navigator, instructions, rawTx):
...
def test_sign_transaction_123(test_name, backend, firmware, navigator):
    ...
    sign_transaction_1559(test_name, backend, navigator, instructions, rawTx)
