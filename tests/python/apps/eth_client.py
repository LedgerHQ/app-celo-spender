...
#         if cert_apdu:
#             self.pki_client.send_certificate(
#                 PKIPubKeyUsage.PUBKEY_USAGE_PLUGIN_METADATA, bytes.fromhex(cert_apdu)
#             )
...
#         if cert_apdu:
#             self.pki_client.send_certificate(
#                 PKIPubKeyUsage.PUBKEY_USAGE_NFT_METADATA, bytes.fromhex(cert_apdu)
#             )
...
#         if cert_apdu:
#             self.pki_client.send_certificate(
#                 PKIPubKeyUsage.PUBKEY_USAGE_NETWORK, bytes.fromhex(cert_apdu)
#             )
