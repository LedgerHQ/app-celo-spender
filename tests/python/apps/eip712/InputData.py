...
def process_data(
    ...
    if app_client.device.type == DeviceType.NANOSP:
    ...
    elif app_client.device.type == DeviceType.NANOX:
    ...
    elif app_client.device.type == DeviceType.STAX:
    ...
    elif app_client.device.type == DeviceType.FLEX:
        ...
        print(f"Invalid device '{app_client.device.name}'")
        cert_apdu = ""
