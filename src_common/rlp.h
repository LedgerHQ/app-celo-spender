 ...
 *
 * This function decodes the length of an RLP encoded field, given a buffer containing the RLP
 * encoded data. The RLP encoding format is defined in the Ethereum wiki:
 * https://github.com/ethereum/wiki/wiki/RLP
 *
 ...
 * @param [out] list A boolean indicating whether the field encodes a list (true) or a string
 * (false).
 *
