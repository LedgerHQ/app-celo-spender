...
UX_STEP_CB_INIT(ux_settings_flow_1_step,
                bnnn_paging,
                {
...
UX_STEP_CB_INIT(ux_settings_flow_2_step,
                bnnn_paging,
                {
...
UX_STEP_CB_INIT(ux_settings_flow_1_step,
                ...
                switch_settings_blind_signing(),
                {"Blind signing", "Enable transaction", "blind signing", g_SettingsText});
...
UX_STEP_CB_INIT(ux_settings_flow_2_step,
                ...
                switch_settings_display_data(),
                {"Debug data", "Display contract data", "details", g_SettingsText});
...
//////////////////////////////////////////////////////////////////////
UX_STEP_NOCB(ux_confirm_selector_flow_1_step,
             pnn,
             {
                 &C_icon_eye,
                 "Verify",
...
UX_STEP_NOCB(ux_confirm_selector_flow_2_step, bn, {"Selector", strings.tmp.tmp});
UX_STEP_CB(ux_confirm_selector_flow_3_step,
           pb,
...
UX_STEP_CB(ux_confirm_selector_flow_4_step,
           pb,
...
//////////////////////////////////////////////////////////////////////
UX_STEP_NOCB(ux_confirm_parameter_flow_1_step, pnn, {&C_icon_eye, "Verify", strings.tmp.tmp2});

UX_STEP_NOCB(ux_confirm_parameter_flow_2_step,
             bnnn_paging,
             {
                 .title = "Parameter",
...
UX_STEP_CB(ux_confirm_parameter_flow_3_step,
           pb,
           io_seproxyhal_touch_data_ok(),
           {
               &C_icon_validate_14,
...
UX_STEP_CB(ux_confirm_parameter_flow_4_step,
           pb,
           io_seproxyhal_touch_data_cancel(),
           {
               &C_icon_crossmark,
...
UX_STEP_NOCB(ux_blind_sign_error_1_step,
             pnn,
             {&C_icon_warning, "Blind signing must", "be enabled in settings"});
...
UX_STEP_NOCB(ux_approval_tx_2_step,
             bnnn_paging,
             {.title = "Amount", .text = strings.common.fullAmount});
...
UX_STEP_NOCB(ux_celo_approval_tx_gateway_fee_step,
             bnnn_paging,
             {
                 .title = "Gateway Fee",
...
UX_STEP_NOCB(ux_celo_approval_staking_type_step,
             bnnn_paging,
             {
                 .title = "Type",
...
UX_STEP_NOCB(ux_celo_approval_staking_validator_step,
             bnnn_paging,
             {
                 .title = "Validator",
                 .text = strings.common.fullAddress,
...
UX_STEP_NOCB(ux_celo_approval_tx_gateway_address_step,
             bnnn_paging,
             {
                 .title = "Gateway Addr",
...
UX_STEP_CB(ux_approval_tx_5_step,
           pbb,
...
UX_STEP_CB(ux_approval_tx_6_step,
           pb,
           io_seproxyhal_touch_tx_cancel(),
           {
               &C_icon_crossmark,
