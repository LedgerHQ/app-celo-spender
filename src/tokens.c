...
const tokenDefinition_t const TOKENS_CELO[NUM_TOKENS_CELO] = {};
// Celo supports paying tx fees using tokens. This is an example of a token Celo will support after mainnet.
